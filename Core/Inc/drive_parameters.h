...
#define CORD_GAIN1                          -24217
#define CORD_GAIN2                          25593
...
#define CORD_MAX_ACCEL_DPPP                 73 /*!< Maximum instantaneous electrical acceleration (dpp per control period) */
...
#define PID_TORQUE_KP_DEFAULT               2535
#define PID_TORQUE_KI_DEFAULT               1183
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2535
#define PID_FLUX_KI_DEFAULT                 1183
...
#define PID_SPEED_KP_DEFAULT                2868/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                2055/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define UD_VOLTAGE_THRESHOLD_V              15 /*!< Under-voltage threshold */
#ifdef NOT_IMPLEMENTED
#define ON_OVER_VOLTAGE                     TURN_OFF_PWM /*!< TURN_OFF_PWM, TURN_ON_R_BRAKE or TURN_ON_LOW_SIDES */
#endif /* NOT_IMPLEMENTED */
#define OV_TEMPERATURE_THRESHOLD_C          85 /*!< Celsius degrees */
...
/* Phase 2 */
#define PHASE2_DURATION                     3200 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT             (1600*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A              1.8

/* Phase 3 */
#define PHASE3_DURATION                     0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (1600*SPEED_UNIT/U_RPM)
