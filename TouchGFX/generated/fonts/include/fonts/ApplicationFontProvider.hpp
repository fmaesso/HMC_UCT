...
struct TypographyFontIndex
{
    ...
    static const touchgfx::FontId TYPOGRAPHY1 = 3; // verdanab_100_4bpp
    static const touchgfx::FontId TYPOGRAPHY2 = 1; // verdana_40_4bpp
    static const touchgfx::FontId TYPOGRAPHY3 = 4; // verdana_20_4bpp
